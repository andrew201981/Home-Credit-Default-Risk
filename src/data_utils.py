...
def get_feature_target(
    ...
    # Assign to y_test the "TARGET" column
        ...
        # Training Features: All columns in app_train except "TARGET"
    X_train = app_train.drop(columns=["TARGET"])
    
    # Training Target: "TARGET" column in app_train
    y_train = app_train["TARGET"]
    
    # Test Features: All columns in app_test except "TARGET"
    X_test = app_test.drop(columns=["TARGET"])
    
    # Test Target: "TARGET" column in app_test
